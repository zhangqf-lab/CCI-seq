...
:bangbang: <b>Note</b>: For the 10x Genomics 3’ V3.1 Kit employed in our study, a 2-bp discrepancy exists between the corresponding barcodes of the two libraries (refer to https://zenodo.org/records/19544434 (https://zenodo.org/records/19544434/files/resource.zip?download=1) `resource.zip` for the mapping relationship). 
<p align="justify" >
